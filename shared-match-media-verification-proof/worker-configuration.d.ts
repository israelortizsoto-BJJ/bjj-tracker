/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d63a16f637e9ae60d77579ed8ca5c23)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	PROOF_MEDIA: R2Bucket;
	PROOF_ENABLED: "0";
	PROOF_HARNESS_VERSION: "verification-container-runtime-proof-v1";
	PROOF_TRIGGER_SECRET: string;
	PROOF_ADMISSION: DurableObjectNamespace<import("./src/index").VerificationProofAdmission>;
	PROOF_CONTAINER: DurableObjectNamespace<import("./src/index").VerificationProofContainer>;
	VERIFICATION_PROOF: Workflow<Parameters<import("./src/index").VerificationProofWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VerificationProofAdmission" | "VerificationProofContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROOF_ENABLED" | "PROOF_HARNESS_VERSION" | "PROOF_TRIGGER_SECRET">> {}
}
